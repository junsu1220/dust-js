...
const serviceKey =
  "Ur95MGVwipykyjNjwt8S5az6Vl9Z5GlPlTwf2J3yf8Xk%2BwOQDJZKCkDT8jiZklAuoN5g4zdfoCjeXq4Ju7MofQ%3D%3D";
//공공데이터 포털에서 받은 내 서비스키

var parse = require("json-parse");
const airdata = (sidoName, callback) => {
  // index.js에서 보내준 시/도 이름을 여기서 받았다.
  ...
  queryParams +=
    "&" + encodeURIComponent("ver") + "=" + encodeURIComponent("1.3"); //버젼
  queryParams +=
    "&" + encodeURIComponent("sidoName") + "=" + encodeURIComponent(sidoName); //시도 이름
  queryParams +=
    "&" + encodeURIComponent("_returnType") + "=" + encodeURIComponent("json"); //josn으로 받기
  ...
  request(
    ...
    function (error, response, body) {
      ...
      callback(undefined, {
        //body를 air이름으로 만들어서 index.js에 보내준다
        air: body,
      });
    }
  );
